...
DEFAULT_SHIPPING = os.getenv('DEFAULT_SHIPPING', '5.99')
...
def api_create_draft_order():
    ...
    for item in items:
        ...
        if not variant_id or quantity < 1:
            return jsonify({'error': 'Ungültiger Artikel oder Menge.'}), 400
